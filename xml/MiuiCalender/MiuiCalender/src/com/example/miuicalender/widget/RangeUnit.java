...
import com.example.miuicalender.util.CalendarUnit;
...
public abstract class RangeUnit extends CalendarUnit {
    ...
    protected LocalDate getFirstEnabled() {
        LocalDate from = getFrom();
    ...
    @Nullable
    abstract public LocalDate getFirstDateOfCurrentMonth(@NonNull LocalDate currentMonth);
